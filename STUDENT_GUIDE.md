# Student Guide: fleet-midi-scale

_Learn how the scale agent works and how to use it._

---

## What You'll Learn

1. What the scale musical concept is
2. How ternary decomposition applies to scale
...
```bash
curl -s http://localhost:2161/health | python3 -m json.tool
```
